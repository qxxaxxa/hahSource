...
public class HHControlPane extends JPanel {
    ...
    private final String[] argStrings = {"Client Status:", "Uptime:", "Last Check-In:", "Total Files Sent:", "Total Files Rcvd:", "Total Bytes Sent:", "Total Bytes Rcvd:", "Avg Bytes Sent:", "Avg Bytes Rcvd:", "Cache Filecount:", "Used Cache Size:", "Cache Utilization:", "Free Cache Size:", "Static Ranges:", "Connections:"};
    ...
    private class StatPane extends JPanel implements StatListener {
        ...
        public void paint(Graphics g) {
            ...
            g2.drawString(Stats.getProgramStatus(), x1pos, yoff + 0);
    ...
    private class GraphPane extends JPanel implements StatListener {
        private final long lastGraphRefresh = 0;
